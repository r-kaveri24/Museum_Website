...
// setup intial delay time for image apperance
...
if (autoRotate) {
  var animatinName = rotateSpeed > 0 ? "spin" : "spinRevert";
  ospin.style.animation = `${animatinName} ${Math.abs(
    rotateSpeed
  )}s  infinite linear`;
}
...
odrag.onpointerdown = function (e) {
  ...
  this.opointerup = function (e) {
    ...
    this.onpointermove = this.opointerup = null;
  };
  return false;
};
